...
ap.add_argument("--mymodel", default=constants.FACE_MODEL_PATH,
    help="Path to recognizer model")
ap.add_argument("--le", default=constants.FACE_DATA_LABEL_PATH,
...
embedding_model =face_model.FaceModel(vars(args))
