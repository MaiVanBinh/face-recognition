...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.data = pickle.load(open(constants.FACE_DATA_VECTOR_PATH, 'rb'))
        self.le = pickle.load(open(constants.FACE_DATA_LABEL_PATH, 'rb'))
        ...
        self.FLIP = 0
        self.THRESHOLD = 1.24
        self.args = {'model': constants.FACE_MODEL_CONFIGURATION,
        ...
        self.model = load_model(constants.FACE_MODEL_PATH)
        self.detector = MTCNN()
